...
class Product(models.Model):
    ...
    shop = models.ForeignKey(
        Shop, on_delete=models.CASCADE, null=False, blank=False)
    likes = models.ManyToManyField(User, related_name="product_likes", default=None, blank=True)
...
class CartProduct(models.Model):
    ...
    product = models.ForeignKey(Product, on_delete=models.CASCADE,
                                null=False, blank=False, related_name='product_cart')
